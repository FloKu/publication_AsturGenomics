    ...
    #PBS -N BWA_Agenschvedowi95
    #PBS -o /media/inter/fkunz/2022_Accipiter/openPBS_logfiles/4_BWA_Agenschvedowi95.logfile
    #PBS -j oe
    ...
    bwa mem /media/inter/fkunz/2022_Accipiter/data/Gentilis_reference/GCF_929443795.1/GCF_929443795.1_bAccGen1.1_genomic.fna     /media/inter/fkunz/2022_Accipiter/results/demultiplex_alldata'/'Agenschvedowi95'.1.fq.gz'     /media/inter/fkunz/2022_Accipiter/results/demultiplex_alldata'/'Agenschvedowi95'.2.fq.gz'     | samtools view -bh     | samtools sort > '/media/inter/fkunz/2022_Accipiter/results/reference_aligned_GCF/'Agenschvedowi95'.bam'
