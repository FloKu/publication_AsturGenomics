    ...
    #PBS -N BWA_Agenatricapillus129W2
    #PBS -o /media/inter/fkunz/2022_Accipiter/openPBS_logfiles/4_BWA_Agenatricapillus129W2.logfile
    #PBS -j oe
